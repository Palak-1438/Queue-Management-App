...
export default async function DashboardPage() {
  ...
  // Rough calculation for avg wait time
  ...
  completed.forEach((t) => {
    if (t.completedAt) {
      totalWaitTime += t.completedAt.getTime() - t.createdAt.getTime();
    }
  });
      ...
      <main className="md:pl-64 pt-6 px-4 md:px-8 pb-12">
        <div className="max-w-7xl mx-auto space-y-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Here's what's happening in your queues today.</p>
          </div>
